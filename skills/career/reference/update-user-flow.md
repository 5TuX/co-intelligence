# Update-User (`/career update-user <handle>`)

1. Read existing `DATA_DIR/<handle>/profile.yaml`
...
5. Optionally: "Add/remove custom sources?" → edit `DATA_DIR/<handle>/sources.yaml`
